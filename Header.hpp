...
string Find_name_of_person(string  id);
...
json Student_answer::turn_to_json(){
    json tmp;
    tmp["student_id"]= this->student_id;
    tmp["Exam_code"] = this->Exam_code;
    tmp["student_answer"]= this->student_answer;
    tmp["sent_score"] = this->sent_score;
    tmp["Question_body"] = this->Question_body;
    tmp["Question_correct_answer"] = this->Question_correct_answer;
...
class Teacher : public Person {
    ...
    public:
        ...
        vector  <Student_answer>  correction_list;
        void Correction();
};
...
void printWelcomeMessage() {
    ...
    cout << "\033[1;36m        WELCOME TO THE SYSTEM!                \033[0m\n";
    cout << "\033[1;34m-----------------------------------------------\033[0m\n";
    cout << "\033[1;32m                       created by Alireza rezaei\033[0m\n";
    cout << "\033[1;35m                              std id : 610303148\033[0m\n";
    return;
}
